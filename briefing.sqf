...
<br/>
	...
	Found a minor bug such as a spelling mistake? Let Moses have a go at fixing it, PM him @ http://www.DAYZUK.com<br/><br/>
	Suspect a player is hacking or exploiting? Please report it at: http://www.DAYZUK.com<br/><br/>
	Please remember this game-mode is in continuous development and there will be bugs. 
"
]
];
